...
--
-- Host: localhost
-- Generation Time: Mar 28, 2026 at 10:15 AM
...
CREATE TABLE `members` (
  ...
  `address` text COLLATE utf8mb4_unicode_ci,
  `category` enum('general','lifetime','advisor') COLLATE utf8mb4_unicode_ci DEFAULT 'general',
...
INSERT INTO `members` (`id`, `image`, `name`, `phone`, `email`, `address`, `category`, `status`, `join_date`, `fee`, `notes`, `nid_number`, `nid_attachment`, `nominee_image`, `nominee_name`, `nominee_mobile`, `nominee_address`, `created_at`, `updated_at`) VALUES
(1, NULL, 'মো. আবদুল করিম', '01711000001', NULL, 'ঢাকা', 'general', 'active', '2024-01-01', '500.00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-27 05:19:27', '2026-03-27 05:19:27'),
(2, NULL, 'ফারহানা বেগম', '01711000002', NULL, 'চট্টগ্রাম', 'lifetime', 'active', '2024-02-15', '5000.00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-27 05:19:27', '2026-03-27 05:19:27');
...
(2, 'omar', 'omar@gmail.com', '$2b$12$UB8ugpwinK2ikUBhuuWr3OEqd1vWfZNCd13TLOEv6C6g7swXuEtPW', '01839707645', 'admin', 'active', '2026-03-27 15:40:01', '2026-03-27 05:28:35', '2026-03-27 15:40:00');
